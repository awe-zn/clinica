...
function initMask() {
  var maskersInputs = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(document.querySelectorAll('input.mask'));

  maskersInputs.forEach(function (input) {
    return (0,imask__WEBPACK_IMPORTED_MODULE_1__.default)(input, {
      mask: input.dataset.mask.split(',').map(function (mask) {
        return {
          mask: mask
        };
      })
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (adminClientSingle);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (adminSubscribers);

/***/ }),

/***/ "./src/js/client-dependents.js":
/*!*************************************!*\
  !*** ./src/js/client-dependents.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clientDependents);

/***/ }),

/***/ "./src/js/client-subscription.js":
/*!***************************************!*\
  !*** ./src/js/client-subscription.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_has_class__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/has-class */ "./src/js/utils/has-class.js");
/* harmony import */ var _utils_validate_inputs_current_tab__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/validate-inputs-current-tab */ "./src/js/utils/validate-inputs-current-tab.js");
...
var nextTabEls, prevTabEls, firstStage, lastStage;
...
function initTabNavigation() {
  nextTabEls.forEach(function (nextTabEl) {
    nextTabEl.addEventListener('click', function () {
      var canPass = (0,_utils_validate_inputs_current_tab__WEBPACK_IMPORTED_MODULE_5__.default)();
      if (!canPass) return null;
      var nextTab = document.querySelector('.tab-stages > .tab-pane.active').nextElementSibling;
      var currentTab = document.querySelector('.tab-stages > .tab-pane.active');
      var nextStage = document.querySelector('.stage.current').nextElementSibling;
      var currentStage = document.querySelector('.stage.current');
...
function updateVisibleStages() {
  ...
  var isLastVisible = !!visibleStages.find(function (stage) {
...
function initMask() {
  var maskersInputs = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(document.querySelectorAll('input.mask'));

  maskersInputs.forEach(function (input) {
    return (0,imask__WEBPACK_IMPORTED_MODULE_3__.default)(input, {
      mask: input.dataset.mask.split(',').map(function (mask) {
        return {
          mask: mask
        };
...
function initStateAndCities() {
  return _initStateAndCities.apply(this, arguments);
}

function _initStateAndCities() {
  _initStateAndCities = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
    var stateSelectEl, states, citySelectEl;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            stateSelectEl = document.querySelector('#titular_state');
            _context2.next = 3;
            return fetchStates();
          ...
          case 3:
            ...
            citySelectEl = document.querySelector('#titular_city');
            stateSelectEl.addEventListener('change', /*#__PURE__*/function () {
              var _ref3 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee(_ref2) {
                var value, placeholderEl, cities;
                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        value = _ref2.target.value;
                        placeholderEl = citySelectEl.querySelector('option:first-child').cloneNode(true);
                        citySelectEl.innerHTML = '';
                        citySelectEl.appendChild(placeholderEl);
                        _context.next = 6;
                        return fetchCities(value);
...
function _fetchStates() {
  _fetchStates = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3() {
    var res, data;
...
function _fetchCities() {
  _fetchCities = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__.default)( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee4(initials) {
    var res, data;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return fetch("https://servicodados.ibge.gov.br/api/v1/localidades/estados/".concat(initials, "/municipios"));
...
function initDependents() {
  new Vue({
    ...
    methods: {
      handleMasks: function handleMasks() {
        var maskersInputs = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(document.querySelectorAll('.tab-pane.active input.mask'));
...
function initFiles() {
  var filesLabelEls = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__.default)(document.querySelectorAll('.input-file'));

  filesLabelEls.forEach(function (el) {
    el.querySelector("input[type=file]#".concat(el.htmlFor)).addEventListener('input', function (_ref) {
      var target = _ref.target;
      var valuesEl = el.querySelector('.input-values');
      valuesEl.innerHTML = '';
      var files = target.files;

      for (var i = 0; i < files.length; i++) {
        var file = files[i];
        var nameArchEl = document.createElement('span');
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (clientSubscription);

/***/ }),

/***/ "./src/js/utils/has-class.js":
/*!***********************************!*\
  !*** ./src/js/utils/has-class.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function hasClass(el, className) {
  var classGroup = Array.apply(void 0, (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(el.classList));
  var hasClassName = classGroup.find(function (currentClassName) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ validateInputsCurrentTab)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/esm/toConsumableArray.js");

function validateInputsCurrentTab() {
  removeFeedback();
  var radio = validateInputsRadio();
  var text = validateInputsText();
...
function validateInputsRadio() {
  ...
  var notChecked = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(currentPane.querySelectorAll('input[type="radio"]:not(:checked)'));

  if (!notChecked) return true;
  var isAllAnswered = true;
  notChecked.forEach(function (el) {
    var elementSelected = !!currentPane.querySelector("input[name=\"".concat(el.name, "\"]:checked"));
...
function validateInputsText() {
  ...
  var secondaryCurrentTabPane = currentTabPane.querySelector('.tab-pane.active');

  if (secondaryCurrentTabPane) {
    var newInputs = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(secondaryCurrentTabPane.querySelectorAll('input:invalid, select:invalid'));

    inputs.push.apply(inputs, (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(newInputs));
    !!newInputs.length && (isAllAnswered = false);
  }

  if (!secondaryCurrentTabPane) {
    var _newInputs = (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(currentTabPane.querySelectorAll('input:invalid, select:invalid'));

    inputs.push.apply(inputs, (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(_newInputs));
    !!_newInputs.length && (isAllAnswered = false);
  }

  inputs.forEach(function (input) {
    var _currentTabPane$query;

    (_currentTabPane$query = currentTabPane.querySelector(".input-feedback[data-target=\"#".concat(input.id, "\"]"))) === null || _currentTabPane$query === void 0 ? void 0 : _currentTabPane$query.classList.add('show');
    console.log(input);
  });
  return isAllAnswered;
}
...
function removeFeedback() {
  (0,_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__.default)(document.querySelectorAll('.input-feedback.show')).forEach(function (input) {
    return input.classList.remove('show');
  });
}
...
/* harmony import */ var _client_dependents__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./client-dependents */ "./src/js/client-dependents.js");
/* harmony import */ var _admin_dashboard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./admin-dashboard */ "./src/js/admin-dashboard.js");
/* harmony import */ var _admin_subscribers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./admin-subscribers */ "./src/js/admin-subscribers.js");
/* harmony import */ var _admin_client_single__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./admin-client-single */ "./src/js/admin-client-single.js");
...
(0,_client_dependents__WEBPACK_IMPORTED_MODULE_4__.default)();
(0,_admin_dashboard__WEBPACK_IMPORTED_MODULE_5__.default)();
(0,_admin_subscribers__WEBPACK_IMPORTED_MODULE_6__.default)();
(0,_admin_client_single__WEBPACK_IMPORTED_MODULE_7__.default)();
})();
